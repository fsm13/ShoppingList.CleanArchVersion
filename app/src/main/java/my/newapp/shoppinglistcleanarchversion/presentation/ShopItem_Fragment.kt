...
class ShopItem_Fragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstanceAddItem(): ShopItem_Fragment {
            val args = Bundle()
            args.putString(EXTRA_SCREEN_MODE, MODE_ADD)
            val fragment = ShopItem_Fragment()
            fragment.arguments = args
            return fragment
        }

        fun newInstanceEditItem(shopItemId: Int): ShopItem_Fragment {
            val args = Bundle()
